...
final class MainController: UIViewController, ARSessionDelegate {
    ...
    override func viewDidLoad() {
        ...
        NSLayoutConstraint.activate([
            ...
            // FPS control positioned at top center
            fpsControl.centerXAnchor.constraint(equalTo: view.centerXAnchor),
            fpsControl.topAnchor.constraint(equalTo: view.safeAreaLayoutGuide.topAnchor, constant: 10),
            fpsControl.widthAnchor.constraint(equalToConstant: 300),
